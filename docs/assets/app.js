...
if(preview&&preview.dataset?.previewMode!=='static'){
...
let openedBy=null;
let loadPromise;
const shortcuts=[siteRoot,'https://www.linkedin.com/in/sammyhawari/','https://github.com/MindlessTruffle','https://x.com/mindlesstruffle'];
