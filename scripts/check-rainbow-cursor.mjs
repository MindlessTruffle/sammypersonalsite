...
let id = 0, imageCount = 0, frameInterval = 0;
...
vm.runInNewContext(source,{document,window,matchMedia:q=>q.includes('reduced')?reduced:fine,
  Image:class{constructor(){imageCount++;}},setInterval:(fn,delay)=>{frameInterval=delay;intervals.set(++id,fn);return id;},clearInterval:id=>intervals.delete(id)});
